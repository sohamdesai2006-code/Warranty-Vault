                ...
                <div className="max-w-4xl mx-auto px-4 md:px-6 flex flex-col gap-6 mt-2">
                    ...
                    <div className="bg-white dark:bg-neutral-800 rounded-2xl border border-gray-400 dark:border-gray-700 p-6 shadow-md transition-colors duration-200">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            {user?.email === process.env.NEXT_PUBLIC_ADMIN_EMAIL && (
                                <div className="flex items-center justify-between border-b border-gray-300 dark:border-neutral-700 pb-3">
                                    ...
                                    <button
                                        ...
                                        className={`w-24 h-10 shrink-0 flex items-center justify-center rounded-md font-medium text-sm transition-all shadow-sm ${sendingEmail ? 'bg-gray-200 text-gray-500 cursor-not-allowed' : 'bg-gray-900 dark:bg-white text-white dark:text-gray-900 hover:opacity-90 active:scale-95'}`}
                                    >
                            ...
                            {/* Welcome Intro Animation Replay */}
                            <div className="flex items-center justify-between border-b border-gray-300 dark:border-neutral-700 last:border-0 pb-3">
                                <div>
                                    <p className="font-medium">Welcome Intro</p>
                                    <p className="text-sm text-gray-500 dark:text-neutral-400">Replay the cinematic onboarding animation</p>
                                </div>
                                <button
                                    onClick={() => router.push('/?replay_intro=true')}
                                    className="w-24 h-10 shrink-0 flex items-center justify-center gap-1.5 bg-gray-900 dark:bg-white text-white dark:text-gray-900 rounded-md font-medium text-sm transition-all hover:opacity-90 shadow-sm active:scale-95"
                                >
                                    <svg className="w-5 h-5 text-white dark:text-black shrink-0" fill="none" stroke="currentColor" strokeWidth="2.2" viewBox="0 0 24 24">
